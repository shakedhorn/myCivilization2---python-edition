...
class GameData:
    UNITS = {
        ...
        "mechanizedInfantry": { "gold_cost": 0, "production_cost": 680, "movement": 3, "melee": 85, "sight": 3, "name": "Mechanized Infantry", "type": "Melee", "range": 0, "UpgradeTo": None, "requiredTech": "composites", "isNaval": False },
        # ===== RANGED =====
    ...
    TECHS = {
        # ===== ANCIENT =====
        "pottery": { "name": "Pottery", "science_cost": 25, "required_techs": [], "unlocked_units": [], "unlocked_buildings": ["granary"] },
        "animalHusbandry": { "name": "Animal Husbandry", "science_cost": 25, "required_techs": [], "unlocked_units": [], "unlocked_buildings": [] },
        "mining": { "name": "Mining", "science_cost": 25, "required_techs": [], "unlocked_units": [], "unlocked_buildings": [] },
        "sailing": { "name": "Sailing", "science_cost": 25, "required_techs": [], "unlocked_units": ["galley"], "unlocked_buildings": [] },
        "astrology": { "name": "Astrology", "science_cost": 50, "required_techs": [], "unlocked_units": [], "unlocked_buildings": ["shrine"] },
        "irrigation": { "name": "Irrigation", "science_cost": 50, "required_techs": ["pottery"], "unlocked_units": [], "unlocked_buildings": [] },
        "writing": { "name": "Writing", "science_cost": 50, "required_techs": ["pottery"], "unlocked_units": [], "unlocked_buildings": ["library"] },
        "archery": { "name": "Archery", "science_cost": 50, "required_techs": ["animalHusbandry"], "unlocked_units": ["archer"], "unlocked_buildings": [] },
        "masonry": { "name": "Masonry", "science_cost": 80, "required_techs": ["mining"], "unlocked_units": [], "unlocked_buildings": ["walls"] },
        "bronzeWorking": { "name": "Bronze Working", "science_cost": 80, "required_techs": ["mining"], "unlocked_units": ["spearman"], "unlocked_buildings": ["barracks"] },
        "wheel": { "name": "Wheel", "science_cost": 80, "required_techs": ["mining"], "unlocked_units": [], "unlocked_buildings": ["waterMill"] },
        # ===== CLASSICAL =====
        "celestialNavigation": { "name": "Celestial Navigation", "science_cost": 120, "required_techs": ["sailing"], "unlocked_units": [], "unlocked_buildings": ["lighthouse"] },
        "currency": { "name": "Currency", "science_cost": 120, "required_techs": ["writing"], "unlocked_units": [], "unlocked_buildings": ["market"] },
        "horsebackRiding": { "name": "Horseback Riding", "science_cost": 120, "required_techs": ["animalHusbandry"], "unlocked_units": ["horseman"], "unlocked_buildings": ["stable"] },
        "ironWorking": { "name": "Iron Working", "science_cost": 120, "required_techs": ["bronzeWorking"], "unlocked_units": ["swordsman"], "unlocked_buildings": [] },
        "shipBuilding": { "name": "Shipbuilding", "science_cost": 120, "required_techs": ["sailing"], "unlocked_units": [], "unlocked_buildings": [] },
        "mathematics": { "name": "Mathematics", "science_cost": 200, "required_techs": ["currency"], "unlocked_units": [], "unlocked_buildings": [] },
        "engineering": { "name": "Engineering", "science_cost": 200, "required_techs": ["wheel"], "unlocked_units": ["catapult"], "unlocked_buildings": [] },
        "construction": { "name": "Construction", "science_cost": 200, "required_techs": ["masonry"], "unlocked_units": [], "unlocked_buildings": [] },
        # ===== MEDIEVAL =====
        "militaryTactics": { "name": "Military Tactics", "science_cost": 275, "required_techs": ["construction"], "unlocked_units": ["pikeman"], "unlocked_buildings": [] },
        "apprenticeship": { "name": "Apprenticeship", "science_cost": 275, "required_techs": ["mining"], "unlocked_units": [], "unlocked_buildings": ["workshop"] },
        "machinery": { "name": "Machinery", "science_cost": 275, "required_techs": ["engineering"], "unlocked_units": ["crossbowman"], "unlocked_buildings": [] },
        "stirrups": { "name": "Stirrups", "science_cost": 275, "required_techs": ["horsebackRiding"], "unlocked_units": ["knight"], "unlocked_buildings": [] },
        "education": { "name": "Education", "science_cost": 335, "required_techs": ["apprenticeship"], "unlocked_units": [], "unlocked_buildings": ["university"] },
        "militaryEngineering": { "name": "Military Engineering", "science_cost": 335, "required_techs": ["construction"], "unlocked_units": [], "unlocked_buildings": ["armory"] },
        "castles": { "name": "Castles", "science_cost": 335, "required_techs": ["engineering"], "unlocked_units": [], "unlocked_buildings": [] },
        # ===== RENAISSANCE =====
        "cartography": { "name": "Cartography", "science_cost": 400, "required_techs": ["shipBuilding"], "unlocked_units": ["caravel"], "unlocked_buildings": [] },
        "gunpowder": { "name": "Gunpowder", "science_cost": 400, "required_techs": ["militaryEngineering"], "unlocked_units": ["musketman"], "unlocked_buildings": [] },
        "massProduction": { "name": "Mass Production", "science_cost": 400, "required_techs": ["shipBuilding"], "unlocked_units": [], "unlocked_buildings": ["shipyard"] },
        "banking": { "name": "Banking", "science_cost": 400, "required_techs": ["education"], "unlocked_units": [], "unlocked_buildings": ["bank"] },
        "printing": { "name": "Printing", "science_cost": 400, "required_techs": ["education"], "unlocked_units": [], "unlocked_buildings": [] },
        "squareRigging": { "name": "Square Rigging", "science_cost": 400, "required_techs": ["cartography"], "unlocked_units": ["frigate"], "unlocked_buildings": [] },
        "astronomy": { "name": "Astronomy", "science_cost": 400, "required_techs": ["education"], "unlocked_units": [], "unlocked_buildings": [] },
        "metalCasting": { "name": "Metal Casting", "science_cost": 400, "required_techs": ["apprenticeship"], "unlocked_units": [], "unlocked_buildings": [] },
        "siegeTactics": { "name": "Siege Tactics", "science_cost": 400, "required_techs": ["castles"], "unlocked_units": ["bombard"], "unlocked_buildings": [] },
        # ===== INDUSTRIAL =====
        "industrialization": { "name": "Industrialization", "science_cost": 490, "required_techs": ["apprenticeship"], "unlocked_units": [], "unlocked_buildings": ["factory"] },
        "scientificTheory": { "name": "Scientific Theory", "science_cost": 490, "required_techs": ["education"], "unlocked_units": [], "unlocked_buildings": [] },
        "ballistics": { "name": "Ballistics", "science_cost": 490, "required_techs": ["gunpowder"], "unlocked_units": ["fieldCannon"], "unlocked_buildings": [] },
        "militaryScience": { "name": "Military Science", "science_cost": 490, "required_techs": ["stirrups"], "unlocked_units": ["cavalry"], "unlocked_buildings": ["militaryAcademy"] },
        "steamPower": { "name": "Steam Power", "science_cost": 490, "required_techs": ["industrialization"], "unlocked_units": [], "unlocked_buildings": ["seaport"] },
        "sanitation": { "name": "Sanitation", "science_cost": 490, "required_techs": ["scientificTheory"], "unlocked_units": [], "unlocked_buildings": [] },
        "economics": { "name": "Economics", "science_cost": 490, "required_techs": ["banking"], "unlocked_units": [], "unlocked_buildings": ["stockExchange"] },
        "rifling": { "name": "Rifling", "science_cost": 490, "required_techs": ["ballistics"], "unlocked_units": ["ranger"], "unlocked_buildings": [] },
        # ===== MODERN =====
        "flight": { "name": "Flight", "science_cost": 600, "required_techs": ["steamPower"], "unlocked_units": ["advancedFlight"], "unlocked_buildings": [] },
        "replaceableParts": { "name": "Replaceable Parts", "science_cost": 600, "required_techs": ["rifling"], "unlocked_units": ["modernArmor"], "unlocked_buildings": [] },
        "steel": { "name": "Steel", "science_cost": 600, "required_techs": ["rifling"], "unlocked_units": ["tank"], "unlocked_buildings": [] },
        "electricity": { "name": "Electricity", "science_cost": 600, "required_techs": ["steamPower"], "unlocked_units": [], "unlocked_buildings": ["powerPlant"] },
        "radio": { "name": "Radio", "science_cost": 600, "required_techs": ["electricity"], "unlocked_units": [], "unlocked_buildings": ["broadcastCenter"] },
        "chemistry": { "name": "Chemistry", "science_cost": 600, "required_techs": ["scientificTheory"], "unlocked_units": [], "unlocked_buildings": ["researchLab"] },
        "combustion": { "name": "Combustion", "science_cost": 600, "required_techs": ["steel"], "unlocked_units": ["tank"], "unlocked_buildings": [] },
        # ===== LATE GAME =====
        "refining": { "name": "Refining", "science_cost": 700, "required_techs": ["combustion"], "unlocked_units": [], "unlocked_buildings": [] },
        "advancedFlight": { "name": "Advanced Flight", "science_cost": 700, "required_techs": ["flight"], "unlocked_units": ["helicopter"], "unlocked_buildings": [] },
        "rocketry": { "name": "Rocketry", "science_cost": 700, "required_techs": ["radio"], "unlocked_units": ["rocketArtillery"], "unlocked_buildings": [] },
        "guidanceSystems": { "name": "Guidance Systems", "science_cost": 700, "required_techs": ["rocketry"], "unlocked_units": ["missileCruiser"],"unlocked_buildings": [] },
        "composites": { "name": "Composites", "science_cost": 700, "required_techs": ["replaceableParts"],"unlocked_units": ["modernArmor"], "unlocked_buildings": [] },
        "syntheticMaterials": { "name": "Synthetic Materials", "science_cost": 700, "required_techs": ["composites"],"unlocked_units": ["specOps"], "unlocked_buildings": [] },
        "advancedBallistics": { "name": "Advanced Ballistics", "science_cost": 700, "required_techs": ["ballistics"],"unlocked_units": ["machineGun"], "unlocked_buildings": [] }
    }
